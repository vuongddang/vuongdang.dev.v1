          ...
          <div className="flex items-center mt-10 space-x-2">
            {socialLinks.map((socialLink, i) => (
              <a
                ...
                key={i}
                className="flex items-center justify-center w-10 h-10 bg-gray-800 rounded-full shadow-xs outline-none group sm:w-12 sm:h-12 transition-colors hover:bg-gray-700 focus:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-green-600"
                type="button"
              >
